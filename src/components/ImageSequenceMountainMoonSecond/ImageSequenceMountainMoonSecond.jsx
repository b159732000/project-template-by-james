...
import './ImageSequenceMountainMoonSecond.scss';

class ImageSequenceSecond extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            imagesBaseUrl: "../../images/Jghx/HouseStyle/Villa/MountainMoon/MountainMoonCombineGif/Second/",    //圖片所在的目錄
        ...
        if (this.imageArray.length === 0) {
            ...
            for (let i = this.state.imageNameStartNumber; i < this.state.totalImagesNumber; i++) {
                ...
                this.imageArray.push(
                    <img ref={self => this.DOMArray.push(self)} className={'image ' + "image" + i + " hidden"} src={require('../../images/Jghx/HouseStyle/Villa/MountainMoon/MountainMoonCombineGif/Second/' + i + this.state.imagesFormat)} onLoad={() => this.handleEachImageLoaded()} key={"image" + currentTime + i} alt="" />
                );
            };
        }
    ...
    render() {
        return (
            <div className="ImageSequenceSecondContainer" onTouchMove={(event) => this.handleTouchMove(event)} onTouchStart={(event) => this.handleTouchStart(event)} onTouchEnd={() => this.handleTouchEnd()}>
                ...
                <div className={(this.state.blurPreviewImageIsShowing) ? ("previewImg") : ("previewImg hidden")}>
                    <img src={require(('../../images/Jghx/HouseStyle/Villa/MountainMoon/MountainMoonCombineGif/Second/' + this.state.imageNameStartNumber + this.state.imagesFormat))} alt="" />
                </div>
...
export default ImageSequenceSecond;