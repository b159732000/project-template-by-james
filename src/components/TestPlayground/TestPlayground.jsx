...
class TestPlayground extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            scrollPercentageContainer1: {
                x: null,
            },
            scrollPercentageContainer2: {
                x: null,
            },
        }
    }
    ...
    componentDidMount() {
        ...
        this.updateImageContainer1Height();
    }
    ...
    // ----- 計算元件在螢幕中移動的百分比 START -----
    updateMainContentHeight() {
        console.log(this.refs.mainContent.offsetHeight);
        console.log(window.screen.height);
    }
    updateImageContainer1Height() {
        console.log(this.refs.movingImage1.offsetHeight);
    }
    updateImageContainer1Height() {
                    ...
                    <div className="contentContainer">
                        ...
                        <div className="imagesContainer">
                            ...
                            <div className="movingImageContainer1" ref="movingImage1">
                                ...
                                <div className="scrollPercentageContainer" ref="scrollPercentageContainer1">
                            ...
                            <div className="movingImageContainer2" ref="movingImage2">
                                ...
                                <div className="scrollPercentageContainer" ref="scrollPercentageContainer2">
                                    <div className="movingImage">
